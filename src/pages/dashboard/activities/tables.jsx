...
export function ActivitiesTable() {
  ...
  const getAllActivities = async () => {
    try {
      ...
      setallInstructor(data.activities);
    ...
    <div className="mt-12 mb-8 flex flex-col gap-12">
      ...
      <Card>
        ...
        >
          ...
          <Box>
            <Link to="/dashboard/add-activities">
              <Button
                size="sm"
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {["S#No", "name", "type", "schedule","gym", "coach", "Action"].map((el) => (
                  <th
                    key={el}
              ...
              {loading ? (
                ...
                <>
                  {allInstructor?.length ? (
                    allInstructor?.map(
                      ({ _id, name, type, schedule, gym, coach }, key) => {
                        ...
                        <Typography className="text-xs font-semibold text-blue-gray-600">
                          {schedule.map(schedule => (
                            <div key={schedule._id} className="bg-gray-200  py-1 rounded mb-1">
                            ...
                            <td className={className}>
                              <Typography className="text-xs font-semibold bg-blue-800 text-gray-300 py-1 rounded-full">
                                {gym.name}
                              </Typography>
                            </td>
                            <td className={className}>
                              <Typography className="text-xs font-semibold  bg-green-800 rounded-full text-gray-300 py-1">
                                {coach.name}
                              </Typography>
                            </td>
